                                ...
                                {showScheduleSection && (
                                    <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid #27272a', borderRadius: '0.5rem', padding: '1rem', marginBottom: '1.5rem' }}>
                                        ...
                                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem', marginBottom: '0.75rem' }}>
                                            ...
                                            <div className="input-group" style={{ margin: 0 }}>
                                                <label className="input-label" style={{ fontSize: '0.8rem' }}>Intervalo mínimo para republicar</label>
                                                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                                                    <input className="input" type="number" min="1" max="365"
                                                        disabled={formData.contentSchedule?.reuseStories === false}
                                                        value={formData.contentSchedule?.storyReuseCooldownDays || 14}
                                                        onChange={(e) => setFormData({
                                                            ...formData,
                                                            contentSchedule: { ...formData.contentSchedule, storyReuseCooldownDays: Number(e.target.value) }
                                                        })} />
                                                    <span style={{ fontSize: '0.8rem', color: '#71717a' }}>dias</span>
                                                </div>
                                            </div>
                                        </div>
